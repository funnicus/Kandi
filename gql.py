...
TYPEDEF_TYPES = ("type", "enum", "interface", "input")
...
class GraphQLLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (words(TYPEDEF_TYPES, suffix=r"\b"), Keyword, "typedef"),
            (r"(union\s+)([a-zA-Z_]*\s*)", bygroups(Keyword, Name.Function), "unionmember"),
        ...
        "unionmember": [
            include("ignored_tokens"),
            (r"([=|\|]\s*)([a-zA-Z_]+\s*)", bygroups(Punctuation, Name.Function)),
            ("", Text, "#pop"), # Maybe a bit of a hack?
        ],
        "operation": [
            include("ignored_tokens"),
